...
-->
[![Build Status](https://travis-ci.com/mollie/laravel-cashier.svg?token=zyonxG2rVP1ddssr2TQq&branch=master)](https://travis-ci.com/mollie/laravel-cashier)
<!--
...
```bash
composer require presttec/laravel-cashier-mollie "^0.1.0"
```
